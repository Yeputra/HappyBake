...
import yuda.freaky.id.happybake.IdlingResource.SimpleIdlingResource;
import yuda.freaky.id.happybake.R;
import yuda.freaky.id.happybake.adapters.RecipeAdapter;
import yuda.freaky.id.happybake.model.Recipe;
import yuda.freaky.id.happybake.retrofit.IRecipe;
import yuda.freaky.id.happybake.retrofit.RetrofitBuilder;

import static yuda.freaky.id.happybake.ui.RecipeDetailActivity.ALL_RECIPES;
