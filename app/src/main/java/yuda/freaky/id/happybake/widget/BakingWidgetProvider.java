package yuda.freaky.id.happybake.widget;
...
import yuda.freaky.id.happybake.ui.RecipeDetailActivity;

import static yuda.freaky.id.happybake.widget.UpdateBakingService.FROM_ACTIVITY_INGREDIENTS_LIST;
